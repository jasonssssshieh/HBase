...
public class RegionServerInfo {
    ...
    public double getReceviedBytes() {
        return receviedBytes;
    }

    public void setReceviedBytes(double receviedBytes) {
